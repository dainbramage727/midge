...
The configurable Slurm-oriented LoRA/QLoRA harness and experiment protocol are documented in [`experiments/README.md`](experiments/README.md) and [`EXPERIMENT_PLAN.md`](EXPERIMENT_PLAN.md).
